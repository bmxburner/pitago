// Package extension owns what gotui borrows from pi extensions at runtime.
//
...
const (
	...
	SourcePrompt    = "prompt"
	SourceSkill     = "skill"
	SourceBuiltin   = "builtin" // gotui-local (see src/builtin), never from RPC
)
...
// ShouldAutoCancel reports UI requests gotui answers without asking:
